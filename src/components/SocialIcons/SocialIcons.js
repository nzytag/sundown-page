...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/" style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
